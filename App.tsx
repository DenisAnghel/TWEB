...
function MyComponent() {
    ...
    return (
        ...
        <div className="container">
            <h1 className="title">Anghel Denis Laboratorul 5.2</h1>
            <header>
            </header>
            <form className="form" onSubmit={handleAddObject}>
                ...
                />
                <input
                    className="input" type="text" placeholder="Prenume" defaultValue={localData.address} onChange={(e) => setLocalData({ ...localData, address: e.target.value })}
                />
                <input
                    className="input" type="text" placeholder="Stand" defaultValue={localData.phone} onChange={(e) => setLocalData({ ...localData, phone: e.target.value })}
                />
