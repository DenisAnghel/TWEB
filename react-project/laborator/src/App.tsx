...
const App = () => {
  ...
  const [cards, setCards] = useState([
    { title: 'Numarul Laboratorului _', content: 'Familia studentului _', prenume: 'Nota _' },
        ...
        <Layout>
          ...
          <Content style={{ padding: '50px' }}>
            <Form form={form} onFinish={handleSubmit}>
              ...
              <Form.Item name="content" rules={[{ required: true, message: 'Introduceti familia studentului' }]}>
                <Input placeholder="Familia studentului" />
              </Form.Item>
